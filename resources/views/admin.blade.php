...
<table class="table table-striped border">
    ...
    @foreach($query AS $c)
    <?php  $var=$c ->id.",'".$c -> ubicacion."','".$c -> estadia."',".$c -> costo_persona.",'".$c -> descripcion."','".$c -> foto."','".$c -> created_at."','".$c -> updated_at."'";?>
    
    <tr>
        <td id="id_alojamiento{{ $c -> id }}" name="">{{ $c -> id }}</td>
        <td id="ubi_alojamiento{{ $c -> id }}" name="">{{ $c -> ubicacion }}</td>
        ...
        <!-- <td><a href="" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" onclick="seleccProduct(<?php echo $c -> id?>,'<?php echo $c -> ubicacion?>','<?php echo $c -> estadia?>',<?php echo $c -> costo_persona?>,'<?php echo $c -> descripcion?>','<?php echo $c -> foto?>')">Ver</a></td> -->
